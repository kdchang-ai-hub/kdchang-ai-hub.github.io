...
const config: Config = {
  ...
  plugins: [
    ...
    [
      ...
      {
        // Keeps old URLs working after a rename. Client-side only, and only
        // generated by `docusaurus build` — not by the dev server.
        redirects: [
          {
            from: "/blog/introducing-kd-ai-hub",
            to: "/blog/introducing-ai-learning-station",
          },
        ],
      },
    ],
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} AI 自學補給站 | AI Learning Station. Built with ❤️ by <a target="_blank" href="https://www.kdchang.com">KD Chang</a> in Taiwan.`,
    },
    prism: {
